...
app.add_url_rule("/ensemble/", methods=["GET"], endpoint="retrieve-ensemble", view_func=get_ensemble)
app.add_url_rule("/ensemble/epc", methods=["GET"], endpoint="retrieve-ensemble", view_func=get_ensemble_epc)
app.add_url_rule("/ensemble/hdf", methods=["GET"], endpoint="retrieve-ensemble", view_func=get_ensemble_hdf)
